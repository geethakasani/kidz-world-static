...
var items = [
  ...
  { name: "Connect 4", quantity: 0, dollars: 19, cents: 99 },
  ...
  { name: "Birthday card", quantity: 0, dollars: 19, cents: 99 },
...
function updatePrice() {
  ...
  return { dollars: finalDollars, cents: finalCents };
}
...
cartButton.onclick = function() {
  ...
  console.log(
    "The total amount is " + price.dollars + "$ and " + price.cents + " cents"
  );
};